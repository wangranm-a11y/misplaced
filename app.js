...
(() => {
      ...
      return `
        <div class="ib-item" data-id="${r.id}">
          ...
          <div class="ib-sticks">
            ...
            <span class="ib-sticks-unit">sticks</span>
          </div>
        </div>
      `;
    }).join('');
  ...
  async function openMuseumItem(id) {
    ...
    // 上香按钮始终可见（可多次上香）
    {
      const sticksLabel = r.incenseSticks ? `🕯 Light another (already ${r.incenseSticks})` : '🕯 Incense';
