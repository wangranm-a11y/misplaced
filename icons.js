...
window.ITEMICON = (function () {
  ...
  // —— 关键词到图标 ID 的映射 ——
  const KW = {
    chargebar: ['power bank', 'charger', 'cable', 'plug', 'usb', 'powerbank'],
    key:       ['key', 'keys', 'keychain', 'fob', 'badge', 'card key'],
    earphone:  ['earphone', 'earphones', 'earbud', 'earbuds', 'AirPods', 'headphone', 'headphones', 'bluetooth'],
    book:      ['book', 'textbook', 'notebook', 'journal', 'diary', 'magazine', 'novel'],
    plush:     ['plush', 'plushie', 'doll', 'toy', 'stuffed', 'teddy', 'bear'],
    umbrella:  ['umbrella', 'parasol'],
    phone:     ['phone', 'iPhone', 'Android', 'mobile', 'cellphone', 'cell'],
    wallet:    ['wallet', 'purse', 'card holder', 'credit card', 'id card', 'license'],
    cup:       ['cup', 'mug', 'bottle', 'thermos', 'flask', 'tumbler', 'water bottle'],
    glasses:   ['glasses', 'sunglasses', 'spectacles', 'specs'],
    bag:       ['bag', 'backpack', 'tote', 'handbag', 'purse', 'satchel'],
    watch:     ['watch', 'wristwatch', 'Apple Watch', 'smartwatch'],
    pen:       ['pen', 'pencil', 'marker', 'highlighter'],
    card:      ['transit card', 'metro card', 'student card', 'meal card'],
    headset:   ['hat', 'cap', 'helmet', 'scarf', 'beanie'],
    sock:      ['sock', 'socks', 'underwear', 'jacket', 'coat', 'shirt', 'pants', 'clothes'],
    food:      ['lunch', 'food', 'coffee', 'tea', 'snack', 'meal'],
    pet:       ['cat', 'dog', 'pet', 'kitten', 'puppy', 'hamster'],
    money:     ['money', 'cash', 'bill', 'cash money'],
  };
